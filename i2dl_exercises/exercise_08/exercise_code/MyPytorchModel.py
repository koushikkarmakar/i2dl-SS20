...
class MyPytorchModel(pl.LightningModule):
    ...
    def prepare_data(self):
        ...
        my_transform = transforms.Compose( [transforms.ToTensor(), transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))])
    ...
    def configure_optimizers(self):
        ...
        ########################################################################
        optim = optimizer.Adam(self.parameters(), lr=self.hparams["learning_rate"], betas=(0.9, 0.999), eps=1e-08, weight_decay=self.hparams["weight_decay"], amsgrad=False)
